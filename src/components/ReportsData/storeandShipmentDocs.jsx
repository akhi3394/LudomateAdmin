    ...
    return (
        <>
            <div className="flex justify-between mb-2">
                <p className="text-[#fff] text-[22px] font-semibold py-3">Store & Access Shipment related Documents</p>
            </div>
            ...
            {editPopup.open && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    ...
                    >
                        ...
                        <h2 className="text-[22px] font-semibold mb-4">Documents</h2>
                        <div className="flex justify-between mb-4">
                            <div>
                                <p className="text-sm text-[#ACACAC]">Document name</p>
                                <p className="text-[16px]">D-#27367</p>
                            </div>
                            <div>
                                <p className="text-sm text-[#ACACAC] text-right">Shipment ID</p>
                                <p className="text-[16px] font-medium">#SIP-63</p>
                            </div>
                        </div>
                        <div className="flex justify-between mb-4">
                            <div>
                                <p className="text-sm text-[#ACACAC]">Document Type</p>
                                <p className="text-[16px]">Bill of loading A</p>
                            </div>
                            <div>
                                <p className="text-sm text-[#ACACAC] text-right">Uploaded By</p>
...
export default StoreandShipmentDoc;