...
const data = [
    {
        id: '24/04/2025 10:30 AM',
        date: 'John Smith',
        type: 'Admin',
        assignedTo: 'Subscription Plan',
        status: 'Company Management',
        priority: '192.168.1.14',
        Success: 'Success'
    },
    {
        id: '24/04/2025 10:30 AM',
                    ...
                    <tbody>
                        {data.map((ticket, index) => (
                            ...
                            >
                                ...
                                <td className="px-5">{ticket.status}</td>
                                <td className="px-5">{ticket.priority}</td>
                                <td className="px-5 relative">
                                    <span
                                        className="bg-[#14AE5C] px-2 py-2 rounded-[24px] text-white cursor-pointer"
